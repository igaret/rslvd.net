...
const PRICES = {
  monthly: { id: process.env.STRIPE_PRICE_MONTHLY, label: 'Monthly', amount: '$0.99/mo', maxHosts: 4, maxTunnels: 4 },
  quarterly: { id: process.env.STRIPE_PRICE_QUARTERLY, label: 'Quarterly', amount: '$1.99/3mo', maxHosts: 12, maxTunnels: 12 },
  semi_annual: { id: process.env.STRIPE_PRICE_SEMI_ANNUAL, label: '6 Months', amount: '$4.99/6mo', maxHosts: 24, maxTunnels: 24 },
  annual: { id: process.env.STRIPE_PRICE_ANNUAL, label: 'Annual', amount: '$8.99/yr', maxHosts: 999999, maxTunnels: 999999 },
};
